interface ChangeRoleTemplateOptions {
  otp: string;
  title?: string;
}

export const changeRoleTemplate = ({ otp, title = "You Are Tagged in Post" }:ChangeRoleTemplateOptions )=> {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8" />
...
<body>
  <div class="box">
    ...
    <table class="header-table">
      <tr>
        <td class="header-E-Commerce">E-Commerce</td>
        <td class="visit-link">
